...
# Read the Excel file
excel_file_path = '/Users/anastassia/Desktop/SYNEDRIA/icsr24/DevGPT2/excels_afterwebsearch/noduplicatescombine.xlsx'
df = pd.read_excel(excel_file_path)

# Iterate over each row and apply word replacement to the specified columns
for index, row in df.iterrows():
    for column_name in ['CommitMessage', 'Title']:  # Specify the column names you want to process
...
output_excel_file_path = '/Users/anastassia/Desktop/SYNEDRIA/icsr24/DevGPT2/excels_afterwebsearch/titles.xlsx'
